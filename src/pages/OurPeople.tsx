...
const teamMembers = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Tech Advisor and Venture Partner at Viet Capital Venture, 2018-2020",
      "Led ERP teams for 7-Eleven Vietnam, BlueBird Taxi Indonesia and vPost Singapore, 2013-2016",
      "USPTO patent author, 2024, on Thermal Energy Storage Solution",
      "CEO of Alpha Bits Technology, building ERPs, blockchain platforms, digital transformation projects and Data/BI dashboards",
      "Guides our technology decisions with a focus on clean data, correct input and clear structure",
    ],
